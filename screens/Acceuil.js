 ...
 function Acceuil (props) {
    ...
    return (
        <View style={styles.container}>
            ...
            <ImageBackground source={require('../assets/img/B13.png')}style={styles.ImageB}>         
           
            <View style={styles.ImageX}>
            <Image  style={styles.ImageX1} source={require('../assets/img/i66.png') } alt=" ImagePharmacie"/>
            </View>



            <View style={styles.Middle}>
              <Text style={styles.BiText}>Bonjour,Ahmed! </Text>
          ...
          <View style= {styles.button12}>
                <View style= {styles.button1}>
                        <TouchableHighlight >
                            ...
                            <Text style= {styles.textbu}>Pharmacie</Text> </Button>                       
                      </TouchableHighlight>    
                 </View>
                 ...
                 <View style= {styles.button2}>
                        <TouchableHighlight onPress= {this.saveButton}>
                            ...
                            <Text style= {styles.textbu}> Produits</Text></Button>                       
                      </TouchableHighlight>    
                 </View>
            </View>    
            <View style= {styles.button3}>
                        <TouchableHighlight onPress= {this.saveButton}>
                            ...
                            <Text style= {styles.textbu}> Localisation</Text></Button>                       
                      </TouchableHighlight>    
                 </View>
            </ImageBackground>
          </View>
